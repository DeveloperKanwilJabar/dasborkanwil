...
def _build_report_viewer_options():
    return {
        ...
        'quick_preset_labels': {
            ...
            'quarter_3': 'Triwulan III',
            'quarter_4': 'Triwulan IV',
            'current_semester': 'Semester Ini',
...
def _serialize_dataset_statistics_config(dataset, active_version):
    ...
    return {
        ...
        'blocks': [
            ...
            {'type': 'narrative', 'title': 'Narasi Statistik Otomatis', 'data_source_alias': 'primary', 'order': 6, 'config': {'focus_field_keys': metric_keys[:3] or ['total'], 'source_mode': 'auto_summary'}},
        ],
    }
